...
// DP TO CHECK IF S3 IS INTERLEAVING OF S1 AND S2
    ...
    class Solution {
        public boolean isInterleave(String s1, String s2, String s3) {
            ...
            // dp[i][j] = s3[0..i+j-1] can be formed using s1[0..i-1] and s2[0..j-1]
    ...
    // ⏱️ TIME COMPLEXITY: O(N*M) — nested loops over lengths of s1 and s2.
    // 🧠 SPACE COMPLEXITY: O(N*M) — dp table to store interleaving states.